...
const Banner = () => {
  ...
  async function fetchData() {
    const result = await highlightTactCode(`
        ...
        <div className="grid grid-cols-2 gap-4 mt-8">
          <div className="lg:col-span-1 col-span-2">
            ...
            <div className="text-base text-gray-500">
              <p>
                Eventon is a message hub for event on TON. It allows you to create a protocol and subscribe to other
                protocols.
              </p>
            </div>
          </div>
          <div className="lg:col-span-1 col-span-2 mockup-code text-sm">{eventSignalCode}</div>
        </div>
      </div>
    </section>
  );
