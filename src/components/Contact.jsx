          ...
          <div className="border-base-300 grid grid-cols-3 flex-col justify-center gap-4 border-t px-8 py-16">
            ...
            >
              <div className="grid h-full grid-rows-6 items-center gap-4">
                <div className="row-span-2  inline-flex h-full items-center justify-center rounded-lg bg-blue-900 text-2xl font-semibold text-blue-100 shadow-lg shadow-blue-950">
                  GitHub
                </div>
                <div className="row-span-2  inline-flex h-full items-center justify-center rounded-lg bg-blue-900 text-2xl font-semibold text-blue-100 shadow-lg shadow-blue-950">
                  Tutorial
              ...
              <div className="flex flex-col gap-y-4">
                {links.map((linkItem, index) => (
                  <a
                    href={linkItem.link}
                    key={index}
                    className="inline-flex h-full items-center justify-center rounded-lg bg-blue-400 py-2 text-2xl font-normal text-black shadow-lg shadow-blue-950 hover:bg-blue-900 hover:text-blue-100"
                  >
                    {linkItem.name}
                  </a>
                ))}
